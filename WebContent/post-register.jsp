...
<body>
	...
	<%
		...
		String total_fare = Reservation.calculatePrice(request.getParameter("total_fare")+"", session.getAttribute("person_type")+"", request.getParameter("one_way_or_round_trip")+"")+"";
		...
		String arrival_datetime = request.getParameter("arrival_time");
		String tid = request.getParameter("tid");
		String transit_line_name = request.getParameter("transit_line_name");
		String one_way_or_round_trip = request.getParameter("one_way_or_round_trip");
		
		reservations = Reservation.registerTicket(username, total_fare, origin_station, destination_station, departure_datetime, arrival_datetime, tid, transit_line_name, one_way_or_round_trip);
				...
				<tbody>
					...
					<tr>
						...
						<td data-label="Delete">
							<form action="delete-register.jsp" method="POST">
